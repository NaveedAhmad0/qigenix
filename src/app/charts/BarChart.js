...
import dot from "../../assets/Ellipse 2813.png"
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div class="container">
                  ...
                  <table class="table table-hover" style={{border: "0.5px solid #2D96D3",borderRadius: "6px",marginTop:"1rem"}}>
                    {/* <thead>
                      <tr>
                        <th>Firstname</th>
                        <th>Lastname</th>
                    ...
                    <tbody>
                      <tr>
                        <td className="dot"><img  style={{height:"13px",width:"13px"}} src={dot} alt="dot"/></td>
                        <td>Lorem Ipsum</td>
                        <td>$45,000</td>
                      </tr>
                      <tr>
